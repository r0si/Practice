...
<script class="cssdeck" src="//cdnjs.cloudflare.com/ajax/libs/jquery/1.8.0/jquery.min.js"></script>
	...
	<div id="container">
        ...
        <form action="${pageContext.request.contextPath}/SearchClientServlet"  method="get">
            <input type="text" placeholder="请输入要查询的信息" name="search">
            <select name="select" style="margin-left:90px;" class="myselect">
...
<div class="w3-container">
	<a href="/zjf/clientlogin.jsp" style="position:absolute;top:230px;" id="btn" class="button button-royal button-pill button-giant">退出登录</a>
